...
def obj2dict(obj):
    ...
    # handle simple types
    elif isinstance(obj, str) or isinstance(obj, bool) or isinstance(obj, int) or isinstance(obj, long) or \
            isinstance(obj, unicode) or isinstance(obj, NoneType):
        d = obj
    else:
        # handle dict
        d = {}
...
class ApplyGiftEvent(GiftEvent):
    ...
    def __init__(self, gift):
        super(ApplyGiftEvent, self).__init__(u'applyGift', gift)
